...
namespace SemihOrhan.WaveOne.CustomEditors
{
    ...
    public class ListOfBoxesEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty setOneAxisToMinimumtPoints = so.FindProperty("setOneAxisToMinimum");
            ...
            if (startPoints.isExpanded)
            {
                ...
                for (int i = 0; i < startPoints.arraySize; i++)
                {
                    ...
                    SerializedProperty size = startPoints.GetArrayElementAtIndex(i).FindPropertyRelative("size");
            ...
            EditorGUILayout.PropertyField(setOneAxisToMinimumtPoints);
